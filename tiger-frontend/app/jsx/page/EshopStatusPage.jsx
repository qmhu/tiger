...
var EshopStatusPage = React.createClass({
	...
	componentDidMount: function(){
		...
		$.ajax({
			url: "/api/report/statusTop?dayBefore=1&status=499"
		}).then(function(data) {
			$(data['accessStatus']).each(function(index){
				table499.row.add([data['accessStatus'][index]['requesturi'],data['accessStatus'][index]['count']])
			});
		...
		$.ajax({
			url: "/api/report/statusTop?dayBefore=1&status=500"
		}).then(function(data) {
			$(data['accessStatus']).each(function(index){
				table500.row.add([data['accessStatus'][index]['requesturi'],data['accessStatus'][index]['count']])
			});
		...
		var table503 = $('#503-table').DataTable({
		  "paging": true,
		  "lengthChange": false,
		  "searching": true,
		  "ordering": true,
		...
		$.ajax({
			url: "/api/report/statusTop?dayBefore=1&status=503"
		}).then(function(data) {
			$(data['accessStatus']).each(function(index){
				table503.row.add([data['accessStatus'][index]['requesturi'],data['accessStatus'][index]['count']])
			});
		...
		$.ajax({
			url: "/api/report/statusTop?dayBefore=1&status=400"
		}).then(function(data) {
			$(data['accessStatus']).each(function(index){
				table400.row.add([data['accessStatus'][index]['requesturi'],data['accessStatus'][index]['count']])
			});
			
			table400.draw();
		});
		
		var table403 = $('#403-table').DataTable({
		  "paging": true,
		  "lengthChange": false,
		  "searching": true,
		  "ordering": true,
		...
		$.ajax({
			url: "/api/report/statusTop?dayBefore=1&status=403"
		}).then(function(data) {
			$(data['accessStatus']).each(function(index){
				table403.row.add([data['accessStatus'][index]['requesturi'],data['accessStatus'][index]['count']])
			});
			
			table403.draw();
		});
		
		var table404 = $('#404-table').DataTable({
		  "paging": true,
		  "lengthChange": false,
		  "searching": true,
		  "ordering": true,
		...
		$.ajax({
			url: "/api/report/statusTop?dayBefore=1&status=404"
		}).then(function(data) {
			$(data['accessStatus']).each(function(index){
				table404.row.add([data['accessStatus'][index]['requesturi'],data['accessStatus'][index]['count']])
			});
		...
		$('#search').click(function(){
			...
			var chartUrl = "/api/report/access";
			...
			if (httpHost != ""){
				chartUrl = chartUrl + "&httpHost=" + httpHost;
			}
			...
			if (responseTime != ""){
				chartUrl = chartUrl + "&responseTime=" + responseTime;
			}
			...
			<section className="content">
				...
				<div className="col-md-12">
				  <div className="box box-info">
					<div className="box-header with-border">
					  <h3 className="box-title">Eshop status code historical chart</h3>
			  ...
			  <div className="row">
				<div className="col-xs-4">
				  <div className="box">
					<div className="box-header">
					  <h3 className="box-title">Status 499(from yesterday 00:00 to today )</h3>
					</div>
					<div className="box-body">
				...
				<div className="col-xs-4">
				  <div className="box">
					<div className="box-header">
					  <h3 className="box-title">Status 500(from yesterday 00:00 to today )</h3>
					</div>
					<div className="box-body">
				...
				<div className="col-xs-4">
				  <div className="box">
					<div className="box-header">
					  <h3 className="box-title">Status 503(from yesterday 00:00 to today )</h3>
					</div>
					<div className="box-body">
					  <table id="503-table" className="table table-bordered table-hover">
						<thead>
						<tr>
						  <th>Url</th>
						  <th>Count</th>
			  ...
			  <div className="row">
				<div className="col-xs-4">
				  <div className="box">
					<div className="box-header">
					  <h3 className="box-title">Status 404(from yesterday 00:00 to today )</h3>
					</div>
					<div className="box-body">
					  <table id="404-table" className="table table-bordered table-hover">
						<thead>
						<tr>
						  <th>Url</th>
						  <th>Count</th>
				...
				<div className="col-xs-4">
				  <div className="box">
					<div className="box-header">
					  <h3 className="box-title">Status 403(from yesterday 00:00 to today )</h3>
					</div>
					<div className="box-body">
					  <table id="403-table" className="table table-bordered table-hover">
						<thead>
						<tr>
						  <th>Url</th>
						  <th>Count</th>
				...
				<div className="col-xs-4">
				  <div className="box">
					<div className="box-header">
					  <h3 className="box-title">Status 400(from yesterday 00:00 to today )</h3>
					</div>
			  ...
			  <div className="box box-default">
				<div className="box-header with-border">
				  <h3 className="box-title">Select a condition to query status code</h3>
				  ...
				  <div className="row">
					<div className="col-md-6">
					  <div className="form-group">
						<label>Domain</label>
						<input type="text" id="httpHost" className="form-control" placeholder="输入域名，比如：'wearefactoryfive.com'"/>
					  </div>
					  ...
					  <div className="form-group">
						...
						<select id="status_select" className="form-control select2" style={{width: '100%'}}>
							<option defaultChecked>200</option>
							<option>499</option>
							<option>500</option>
							<option>503</option>
							<option>400</option>
					...
					<div className="col-md-6">
					  <div className="form-group">
						...
						<input type="text" id="contentPath" className="form-control" placeholder="输入contentPath，比如'/order'"/>
					  </div>
					  
					  <div className="form-group">
						<label>ResponseTime Large Than(ms)</label>
						<input type="text" id="responseTime" className="form-control" placeholder="输入response time，比如'500'"/>
					  </div>
					</div>
			  ...
			  <div className="row">
				<div className="col-md-12">
				  <div className="box box-info">
					<div className="box-header with-border">
					  <h3 className="box-title">Eshop Status Detail</h3>
...
export default EshopStatusPage